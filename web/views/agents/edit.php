  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
		...
		echo form_open("agents/edit",$attributes);?>
			...
			<div class="row">
				<div class="form-group col">
					...
					<input type="text" class="form-control" id="username" name="username" placeholder="Enter Username" value="<?php echo $fields->username;?>" required />
				</div>
				<div class="form-group col">
					<label>Password / Secret</label>
					<input class="form-control" id="secret" name="secret" placeholder="Enter Password / Secret" value="<?php echo $fields->secret;?>" required />
				</div>
			</div>
			<div class="row">
				<div class="form-group col">
			...
			<input class="form-control" type="hidden" id="agent_id" name="agent_id" value="<?php echo $fields->id;?>" />
			<button type="submit" class="btn btn-success btn-sm">Update Agent</button>
