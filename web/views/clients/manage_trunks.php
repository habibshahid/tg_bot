  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="mt-4">Manage Trunks - <?php echo $user->first_name . ' ' . $user->last_name; ?></h3>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Manage Trunks</li>
          </ol>
        </nav>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header bg-success text-white">
                <h5><i class="fas fa-users"></i> Associated Trunks (<?php echo count($associated_agents); ?>)</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header bg-primary text-white">
                <h5><i class="fas fa-plus-circle"></i> Available Trunks (<?php echo count($available_agents); ?>)</h5>
              </div>
              <div class="card-body">
  ...
  $(document).ready(function(){
    ...
    $('.associate-agent').click(function(){
      ...
      if(confirm('Associate agent "' + agentName + '" with this user?')){
        $.ajax({
          url: '<?php echo base_url(); ?>clients/associate_trunk',
          type: 'POST',
          data: {
            user_id: userId,
            agent_id: agentId
    ...
    $('.remove-agent').click(function(){
      ...
      if(confirm('Remove association of agent "' + agentName + '" from this user?')){
        $.ajax({
          url: '<?php echo base_url(); ?>clients/remove_trunk_association',
          type: 'POST',
          data: {
            agent_id: agentId
          },
