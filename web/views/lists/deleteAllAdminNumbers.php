  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Delete All Admin Numbers</h1>
		<span style="color:red"><?php if(isset($errors) && $errors !== ''){echo ($errors['error']);}?></span>
        <?php $attributes = array('class'=>'form-signin');
		echo form_open("lists/deleteAllAdmin",$attributes);?>
			<div class="form-group">
				<span>Are you sure you want to delete <?php echo $fields->totalCount; ?> numbers?</span>
			</div>
			<input type='hidden' id="list_id" name="list_id" value="<?php echo $fields->id; ?>" />
			<button type="submit" class="btn btn-danger btn-sm">Delete Numbers</button>
